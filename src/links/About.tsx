...
const About: React.FC = () => {
    return (
        <div className="about-container">
            ...
            <p>
                Tekken (Japanese: 鉄拳 literal translation: Tetsu no ken, "Iron Fist") is a Japanese media franchise centered on a series of fighting video and arcade games developed and published by Bandai Namco Entertainment (formerly Namco). The franchise also includes film and print adaptations.
            ...
            <p>
                Explore new and familiar characters, each with their unique fighting styles
                and storylines. Master the advanced combat mechanics and compete against
                players from around the world in online battles.
            </p>
            <p>
                Tekken 8 delivers a thrilling gaming experience, combining tradition with
                innovation to create a must-play title for fans and newcomers alike.
            </p>
        </div>
    );
};
